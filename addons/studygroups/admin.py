...
from addons.studygroups.models import StudyGroup, Position, Officer
from addons.studygroups.forms import StudyGroupAdminForm, StudyGroupAdminChangelistForm
